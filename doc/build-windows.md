...
The next three steps are an example of how to acquire the source in an appropriate way.
    ...
    cd /usr/src
    sudo git clone https://github.com/fujicoin/fujicoin.git
    sudo chmod -R a+rw fujicoin
...
It's not possible to build the fujicoin code using the win32 version of the Mingw-w64 cross compilers (at least not without
modifying headers in the fujicoin source code).
